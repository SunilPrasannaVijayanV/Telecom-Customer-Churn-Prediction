...
```bash
git clone https://github.com/SunilPrasannaVijayanV/Telecom-Customer-Churn-Prediction.git
...
**Sunil Prasanna Vijayan V**  
*Data Science & Machine Learning Practitioner*

- 🐙 **GitHub**: [@SunilPrasannaVijayanV](https://github.com/SunilPrasannaVijayanV)
